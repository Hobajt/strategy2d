...
namespace eng {
    ...
    public:
        ...
        void RenderTextKeyValue(const char* text, size_t sep_pos, const glm::vec2 center, float scale, const glm::vec4& color1, const glm::vec4& color2, const glm::ivec2& highlightRange, float zIndex = -0.9f, const glm::uvec4& info = glm::uvec4(0));
        ...
        void RenderTextCentered(const char* text, const glm::vec2 center, float scale, const glm::vec4& color1, const glm::vec4& color2, const glm::ivec2& highlightRange, const glm::ivec2& pxOffset, float zIndex = -0.9f, const glm::uvec4& info = glm::uvec4(0));
